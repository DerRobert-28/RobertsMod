...
import net.mcreator.derrobert.world.features.ores.WinMazeWoodFeature;
import net.mcreator.derrobert.world.features.ores.WinMazeStoneFeature;
import net.mcreator.derrobert.world.features.ores.WinMazePaintingFeature;
import net.mcreator.derrobert.world.features.ores.WinMazeBricksFeature;
...
import net.mcreator.derrobert.world.features.ores.LyingGrassFeature;
...
public class DerRobertModFeatures {
	...
	public static final RegistryObject<Feature<?>> LYING_GRASS = REGISTRY.register("lying_grass", LyingGrassFeature::new);
	...
	public static final RegistryObject<Feature<?>> WIN_MAZE_BRICKS = REGISTRY.register("win_maze_bricks", WinMazeBricksFeature::new);
	public static final RegistryObject<Feature<?>> WIN_MAZE_WOOD = REGISTRY.register("win_maze_wood", WinMazeWoodFeature::new);
	public static final RegistryObject<Feature<?>> WIN_MAZE_STONE = REGISTRY.register("win_maze_stone", WinMazeStoneFeature::new);
	public static final RegistryObject<Feature<?>> WIN_MAZE_PAINTING = REGISTRY.register("win_maze_painting", WinMazePaintingFeature::new);
