...
public class Tnt10IgnitionProcProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		DerRobertMod.queueServerWork(10, () -> {
			world.setBlock(BlockPos.containing(x, y, z), DerRobertModBlocks.TNT_10_BLOCK.get().defaultBlockState(), 3);
			DerRobertMod.queueServerWork(10, () -> {
				world.setBlock(BlockPos.containing(x, y, z), DerRobertModBlocks.CLASSIC_TNT_IGNITED.get().defaultBlockState(), 3);
				DerRobertMod.queueServerWork(10, () -> {
					world.setBlock(BlockPos.containing(x, y, z), DerRobertModBlocks.TNT_10_BLOCK.get().defaultBlockState(), 3);
								...
								DerRobertMod.queueServerWork(10, () -> {
									...
									DerRobertMod.queueServerWork(10, () -> {
										...
										DerRobertMod.queueServerWork(10, () -> {
											world.setBlock(BlockPos.containing(x, y, z), DerRobertModBlocks.TNT_10_BLOCK.get().defaultBlockState(), 3);
											DerRobertMod.queueServerWork(10, () -> {
												Tnt10ExplodeProcProcedure.execute(world, x, y, z);
											});
										});
									});
								});
