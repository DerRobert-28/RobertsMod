...
import net.mcreator.derrobert.procedures.PlasticPaintBrushProc11Procedure;
import net.mcreator.derrobert.procedures.OnPlasticPaintBrushProcProcedure;

public class PlasticPaintBrush11Item extends Item {
	public PlasticPaintBrush11Item() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		PlasticPaintBrushProc11Procedure.execute(world, x, y, z);
		return ar;
	}
