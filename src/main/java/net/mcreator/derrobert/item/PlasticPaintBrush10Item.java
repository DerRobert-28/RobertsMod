...
import net.mcreator.derrobert.procedures.PlasticPaintBrushProc10Procedure;
import net.mcreator.derrobert.procedures.OnPlasticPaintBrushProcProcedure;

public class PlasticPaintBrush10Item extends Item {
	public PlasticPaintBrush10Item() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		PlasticPaintBrushProc10Procedure.execute(world, x, y, z);
		return ar;
	}
