...
import net.mcreator.derrobert.procedures.PlasticPaintBrushProc8Procedure;
import net.mcreator.derrobert.procedures.OnPlasticPaintBrushProcProcedure;

public class PlasticPaintBrush8Item extends Item {
	public PlasticPaintBrush8Item() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		PlasticPaintBrushProc8Procedure.execute(world, x, y, z);
		return ar;
	}
