...
public class NotchRenderer extends HumanoidMobRenderer<NotchEntity, HumanoidModel<NotchEntity>> {
	...
	public ResourceLocation getTextureLocation(NotchEntity entity) {
		return new ResourceLocation("der_robert:textures/entities/notch.png");
	}
}
